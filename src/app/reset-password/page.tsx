    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0F0C0A] px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <div className="mt-8 bg-[#1F1A15] border border-[#D4AF37]/10 rounded-xl p-6">
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0F0C0A] px-4">
      <div className="w-full max-w-sm">
        ...
        {success ? (
          ...
          <form onSubmit={handleUpdatePassword} className="bg-[#1F1A15] border border-[#D4AF37]/10 rounded-xl p-6 space-y-4">
            {error && (
